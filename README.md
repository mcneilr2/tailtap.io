...
- Create client - Nov 24th

  - react project with routes w boilerplate html/scss
  - Nov 24th

- Create server - Nov 26th

  - express project with routing, with placeholder responses
  - Nov 26th

- Create migrations - Nov 26th

  - Nov 26th

- Create seeds - Nov 26th

  - created seeds for two spots, moving on to build out stack

- Feature: View skatespot

  - Implement view skatespot page
  - Youtube Video Hero - Nov 27th
  - Header
  - Page Title
  - Spot details section
  - Create GET /spots/:id

- Feature: Populate footage section
  - Create GET /spots/:id/footage
  - Create GET /spots/:id/features
